...
Graph.add_node("Lysosome")
Graph.add_node("Endosome")
Graph.add_node("Secretory vesicle")

Graph.add_edge("ER","Lysosome")
Graph.add_edge("ER","Golgi")
Graph.add_edge("Golgi","ER")
Graph.add_edge("Golgi","Lysosome")
Graph.add_edge("Lysosome","Golgi")
Graph.add_edge("Lysosome","Secretory vesicle")
Graph.add_edge("Golgi","Secretory vesicle")
Graph.add_edge("Lysosome","Endosome")
Graph.add_edge("Endosome","Lysosome")
Graph.add_edge("Endosome","Extracellular")
Graph.add_edge("Secretory vesicle","Extracellular")
...
def updateLine(val):
    ...
    while onOff:
        ...
        print(output[-1,:6])
        ax.cla()
        nx.draw(Graph,ax=ax,pos=fixedpos,node_size=output[-1,:6]*10000,width=3,with_labels=True)
        #plt.draw()
